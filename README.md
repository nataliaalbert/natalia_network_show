                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        Groups                          462,489         53.6%
                                                                                                                                                                                                                            Institutions                    218,748         25.3%
                                                                                                                                                                                                                                Social Cohesion Dimensions      165,272         19.1%
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    The testing plan uses a 3 datasets x 4 dictionaries = 12 combination runs design, following Wang et al. (2025). Priority run order: sample_C + dict1 (baseline), then sample_C + dict2, dict3, dict4, then repeat with sample_A and sample_B.
